...
// Chú ý 
// 1. thẻ Link không liên kết với path bên ngoài trang web như thẻ a.
// 2. Dù dùng thẻ Link nhưng trên DOM thật ta vẫn thấy thẻ a nhưng cách hoạt động sẽ không giống thẻ a bằng preventDefault..
function App()
{
    return (
        <>
