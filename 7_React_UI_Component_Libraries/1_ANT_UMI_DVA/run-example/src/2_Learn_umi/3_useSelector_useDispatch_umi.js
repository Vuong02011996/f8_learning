...
// Truyên tên namespace nào thì lấy dữ liệu store của namespace đó, dù namespace đó ở đâu trong project.
...
// biến camera phải trùng với tên namespace của model mới lấy được dữ liệu
// => model sẽ trả về object gồm 2 key: loading, tên_namespace.
const [loading, { pagination, error, data, branches, classes }] = useSelector(({ loading: { effects }, camera }) => [
    effects,
    camera,
]);
